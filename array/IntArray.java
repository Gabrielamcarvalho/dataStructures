package array;
/**
 * Most of the time when you use an array it's to place integers inside of it,
 * so why not have a super fast integer only array? This file contains an
 * implementation of an integer only array which can outperform Java's ArrayList
 * by about a factor of 10-15x! Enjoy!
 *
...
public class IntArray implements Iterable<Integer> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(myArray.capacity); //print 5
        myArray.add(2);
        myArray.add(3);
        myArray.add(1);
        myArray.add(4);
        ...
        myArray.add(6);
        myArray.add(8);
        System.out.println(myArray.capacity); //print 10
        System.out.println(myArray.get(1)); //print 3
        System.out.println(myArray.size()); //print 8
        System.out.println(myArray.isEmpty()); //print false
        System.out.println(myArray); //print [2, 3, 1, 4, 5, 7, 6, 8]
        myArray.remove(3);
        System.out.println(myArray); //print [2, 1, 4, 5, 7, 6, 8]
        myArray.removeAt(0);
        myArray.sort();
        System.out.println(myArray); //print [1, 4, 5, 6, 7, 8]
        System.out.println(myArray.binarySearch(4)); //print 1
        System.out.println(myArray.toString()); //print [1, 4, 5, 6, 7, ,8]
    }
}