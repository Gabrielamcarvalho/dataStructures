 ...
 * java.util.ArrayDeque (Java's fastest queue implementation) by a factor of
 * 40+! See the benchmark test below for proof. However, the downside is you
 * need to know an upper bound on the number of elements that will be inside the
 * queue at any given time for this queue to work.
 *
